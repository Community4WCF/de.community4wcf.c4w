...
/**
 * Shows the welcome page in the C4W admin control panel.
 * 
...
class IndexPage extends AbstractPage {
	...
	protected function readStat() {
		WCF::getCache()->addResource('acpstat', C4W_DIR.'cache/cache.acpstat.php', C4W_DIR.'lib/system/cache/CacheBuilderACPStat.class.php', 0, 3600 * 12);
