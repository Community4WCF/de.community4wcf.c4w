...
/**
 * This class extends the main WCF class by c4w specific functions.
 * 
 * @svn			$Id: C4WpagePage.class.php 1207 2010-04-09 23:32:46Z TobiasH87 $
 * @package		de.community4wcf.c4w
 */
class C4WCore extends WCF implements PageMenuContainer, UserCPMenuContainer, UserProfileMenuContainer {
	...
	public static $availablePagesDuringOfflineMode = array(
		...
		'form' => array('UserLogin', 'LostPassword', 'NewPassword'),
	...
	protected function initTPL() {
		...
		// check offline mode
		if (OFFLINE && !self::getUser()->getPermission('user.c4w.canViewC4WOffline')) {
	...
	public static function loadDefaultC4WCacheResources() {
		WCF::getCache()->addResource('stat', C4W_DIR.'cache/cache.stat.php', C4W_DIR.'lib/system/cache/CacheBuilderStat.class.php', 0, 300);
	...
	/**
	 * Initialises the page menu.
	 */
	protected static function initPageMenu() {
		require_once(WCF_DIR.'lib/page/util/menu/PageMenu.class.php');
		self::$pageMenuObj = new PageMenu();
		if (PageMenu::getActiveMenuItem() == '') PageMenu::setActiveMenuItem('c4w.header.menu.index');
	}
	...
	protected function initSession() {
		// start session
		require_once(C4W_DIR.'lib/system/session/C4WSessionFactory.class.php');
		$factory = new C4WSessionFactory();
